...
from azure.mgmt.apimanagement.models import (SkuType, VirtualNetworkType, ProductState, SoapApiType, ContentFormat)
...
def load_arguments(self, _):
    ...
    with self.argument_context('apim subscription') as c:
        ...
        #c.argument('productId', arg_group='Subscription', help='The specific productId when scope is set to products')
        #c.argument('apiId', arg_group='Subscription', help='The specific apiId when scope is set to apiId')
